...
public class Hash<T extends Comparable<T>> implements Serializable {
...
/**Accessors*/
    ...
    /**
     * Get value for a specified key in the Table
     *
     * @param t the key to search for
...
/**Additional Methods*/
    ...
    public ArrayList<T> getArray(){
        ...
        for(List<T> bucketL : Table){
            bucketL.pointIterator();
            while (!bucketL.offEnd()) {
                arr.add(bucketL.getIterator());
                bucketL.advanceIterator();
            }
        }
        return arr;
